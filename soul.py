...
TOKEN = '7496224948:AAFR9BHraYdgugi9HdtoMcn5T2i8OedyIsg'
...
FORWARD_CHANNEL_ID = -1002231107867
CHANNEL_ID = -1002231107867
error_channel_id = -1002231107867
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/1474132529/3404*", parse_mode='Markdown')
